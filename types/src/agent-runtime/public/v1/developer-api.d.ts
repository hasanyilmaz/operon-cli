 ...
 */
export type DeepReadonlyV1<T> = T extends (...args: never[]) => unknown ? T : T extends readonly (infer Item)[] ? readonly DeepReadonlyV1<Item>[] : T extends object ? {
    readonly [Key in keyof T]: DeepReadonlyV1<T[Key]>;
} : T;
export type DeveloperApiChannelAvailabilityV1 = 'available' | 'degraded' | 'unavailable';
export type DeveloperApiChannelReasonV1 = 'ready' | 'booting' | 'cache-ready' | 'settling' | 'unloading' | 'terminal-startup-failure' | 'accessor-unavailable' | 'unsupported-platform' | 'unsupported-version';
...
export type OperonDeveloperApiAccessResultV1 = Readonly<{
    contractVersion: 1;
...
export interface OperonDeveloperApiAccessorV1 {
    readonly getDeveloperApiV1: (consumerPlugin: OperonDeveloperApiConsumerPluginV1, request: OperonDeveloperApiAccessRequestV1) => OperonDeveloperApiAccessResultV1;
}
...
export interface DeveloperApiCatalogV1 {
    readonly snapshot: (request?: DeepReadonlyV1<CatalogRequestV1>) => Promise<DeepReadonlyV1<OperonCatalogV1>>;
}
export interface DeveloperApiEntitiesV1 {
    readonly resolve: (request: DeepReadonlyV1<EntityResolveRequestV1>) => Promise<DeepReadonlyV1<EntityResolutionResultV1>>;
}
...
export interface DeveloperApiRelationshipsV1 {
    readonly get: (request: DeepReadonlyV1<RelationshipRequestV1>) => Promise<DeepReadonlyV1<RelationshipResultV1>>;
}
export interface DeveloperApiContextV1 {
    readonly build: (request: DeepReadonlyV1<ContextRequestV1>) => Promise<DeepReadonlyV1<ContextPackV1>>;
}
export interface DeveloperApiTimersV1 {
    readonly read: (request: DeepReadonlyV1<TimerReadRequestV1>) => Promise<DeepReadonlyV1<TimerReadResultV1>>;
}
/**
 ...
 */
type DeveloperTargetedMutationPreviewInputV1<Kind extends MutationKindV1, Capability extends CapabilityIdV1, Spec> = Readonly<{
 ...
 */
export type DeveloperMutationPreviewInputV1 = Readonly<{
...
}> | DeveloperTargetedMutationPreviewInputV1<'task.recurrence', 'tasks.recurrence.preview', UpdateTaskRecurrenceSpecV1> | DeveloperTargetedMutationPreviewInputV1<'task.relationship', 'tasks.relationship.preview', ReplaceTaskRelationshipsSpecV1> | DeveloperTargetedMutationPreviewInputV1<'task.reminder-item', 'tasks.reminder.preview', ReminderItemSpecV1> | DeveloperTargetedMutationPreviewInputV1<'task.transition', 'tasks.transition.preview', TransitionTaskSpecV1> | DeveloperTargetedMutationPreviewInputV1<'task.pinned-state', 'tasks.pinned.preview', PinnedTaskStateSpecV1> | Readonly<{
    capability: 'timers.control.preview';
    mutationKind: 'timer.control';
    target?: DeepReadonlyV1<ExactMutationTargetV1>;
    spec: DeepReadonlyV1<TimerControlSpecV1>;
}> | DeveloperTargetedMutationPreviewInputV1<'timer.session', 'timers.session.preview', TimerSessionSpecV1> | DeveloperTargetedMutationPreviewInputV1<'task.convert', 'tasks.convert.preview', ConvertTaskSpecV1> | DeveloperTargetedMutationPreviewInputV1<'task.inline-relocate', 'tasks.inline.relocate.preview', RelocateInlineTaskSpecV1 | RelocateInlineTaskPreviewIntentV1> | DeveloperTargetedMutationPreviewInputV1<'task.delete', 'tasks.delete.preview', DeleteTaskSpecV1>;
...
export type DeveloperMutationPreviewResultV1 = Readonly<{
    contractVersion: 1;
...
export type DeveloperMutationRecoverInputV1 = Readonly<{
    plan: DeveloperMutationPlanHandleV1;
    recoveryRef?: never;
}> | Readonly<{
    recoveryRef: string;
...
export interface DeveloperMutationPendingRecoveryV1 extends DeveloperMutationRecoveryRefV1 {
    readonly mutationKind: MutationKindV1;
    readonly capability: CapabilityIdV1;
    readonly riskLevel: RiskLevelV1;
    readonly createdAt: string;
...
export type DeveloperMutationPendingRecoveriesResultV1 = Readonly<{
    contractVersion: 1;
...
export type DeveloperMutationExecutionResultV1 = DeveloperMutationExecutionResultBaseV1 & ({
    readonly status: 'applied';
    readonly mutationMayHaveApplied: true;
    readonly retryAllowed: false;
    readonly receipt: DeveloperMutationReceiptV1 & {
        readonly terminalOutcome: 'applied';
    };
    readonly postflight: DeepReadonlyV1<MutationPostflightV1> & {
    ...
    readonly retryAllowed: false;
    readonly receipt: DeveloperMutationReceiptV1 & {
        readonly terminalOutcome: 'already-applied';
    };
    readonly postflight: DeepReadonlyV1<MutationPostflightV1> & {
        readonly status: 'receipt-replay';
    };
    readonly error?: never;
    readonly recovery?: never;
} | {
...
export interface DeveloperApiMutationsV1 {
    readonly preview: (input: DeveloperMutationPreviewInputV1) => Promise<DeveloperMutationPreviewResultV1>;
    readonly apply: (input: DeveloperMutationApplyInputV1) => Promise<DeveloperMutationExecutionResultV1>;
    readonly recover: (input: DeveloperMutationRecoverInputV1) => Promise<DeveloperMutationExecutionResultV1>;
