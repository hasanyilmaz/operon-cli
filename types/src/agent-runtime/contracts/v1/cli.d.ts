...
import type { CompatibilityOfferV1, CompatibilitySelectionV1, ContractWarningV1, StructuredErrorV1 } from './primitives.js';
...
export declare const CLI_EXIT_CODES_V1: Readonly<{
    readonly success: 0;
    readonly usage: 2;
    readonly unavailable: 3;
    readonly refused: 4;
    readonly runtimeFailure: 5;
...
export declare function isCliCommandV1(value: string): value is CliCommandV1;
export declare function resolveCliInvocationCapabilityV1(invocation: Pick<CliInvocationV1, 'command' | 'request'>): CapabilityIdV1 | undefined;
export declare function cliRequestKindForCommandV1(command: CliCommandV1): CliRuntimeRequestV1['kind'] | undefined;
export declare function cliResultKindForCommandV1(command: CliCommandV1): string | undefined;
export {};
