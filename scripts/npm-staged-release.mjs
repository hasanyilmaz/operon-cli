...
const RELEASE_WORKFLOW_SHA256 = '4a303a7d30ed72c93fed9d2f131cefb1d0cef28852f4bc3b80c5f0a1d0e2ba23';
...
export async function artifactCheckV1(
	...
	assert.deepEqual(names, ['artifact-manifest.json', 'determinism-report.json', 'operon-cli-1.2.0.tgz'], 'OPERON_CLI_RELEASE_ARTIFACT_INVENTORY_MISMATCH');
