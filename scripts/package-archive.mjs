...
export const EXPECTED_PACKAGE_PATHS_V1 = Object.freeze([
	...
	'package/schemas/v1/extensions/task-workflows-v1/capabilities.schema.json',
	'package/schemas/v1/extensions/task-workflows-v1/cli.schema.json',
	'package/schemas/v1/extensions/task-workflows-v1/developer-api.schema.json',
	'package/schemas/v1/extensions/task-workflows-v1/extension-manifest.json',
	'package/schemas/v1/extensions/task-workflows-v1/mutation.schema.json',
	'package/schemas/v1/extensions/task-workflows-v1/read.schema.json',
	...
	'package/types/src/agent-runtime/extensions/task-workflows-v1/contracts.d.ts',
